    ...
    <div class="tabs" id="tabsDiv">
      ...
      <div class="tab-content">
        <div id="summary" class="tab-pane fade in active">
          ...
          <div id="sum"></div>
          <footer>
  			<table id="legend" class="table table-hover">
  				<tr>
  					<td> 
  						<p>Unavailable: </p>
  						<img alt="Unavailable" src="../resources/images/unavailable.jpeg">
  					</td>
  					<td>  
  						<p>Safe: 0% - 74%</p>
  						<img alt="Safe: 0% - 74%" src="../resources/images/safe.jpeg">
  					</td>
  					<td>  
  						<p>Warning: 75% - 89%</p>
  						<img alt="Warning: 75% - 89%" src="../resources/images/warning.jpeg">
  					</td>
  					<td>  
  						<p>Alarming: 90% - 100%</p>
  						<img alt="Alarming: 90% - 100%" src="../resources/images/alarming.jpeg">
  					</td>
  				</tr>
  			</table>
		  </footer>
